    ...
    data: {
        experiences: [
            {
                ...
                'description': 'Managed a team of 4 developers working on a key company product. <br class="d-none d-lg-block"/>' +
                'Coordinated interactions between the UI/UX team, the QA team and developers. <br class="d-none d-lg-block"/>' +
                'Was responsible for defining development methodologies and project processes. ( <a href="dev_guidelines.pdf">guidelines</a>, ... )<br class="d-none d-lg-block"/>' +
                'Developed a chrome extension that automatically inserts a personalised email signature <br class="d-none d-lg-block"/> on GMail and Office365. ' +
                'Shipped the extension to 15 000 users.<br class="d-none d-lg-block"/>' +
                'Implemented an administrative console that allows system administrators <br class="d-none d-lg-block"/> to configure their SMTP server and synchronise with their LDAP directory.',
                'stack': [
            ...
            },
            {
                ...
                'description': 'Developed several components of the backup & restore Android application <br class="d-none d-lg-block"/>' +
            ...
            },
            {
                ...
                'description': 'Implemented Airbus\'s customer portal which allows a customer <br class="d-none d-lg-block"/>' +
            ...
            },
            {
                ...
                'description': 'Developed an electrical load analysis tool to validate helicopters\' proper electrical wiring. <br class="d-none d-lg-block"/>' +
        ...
        personalProjects: [
            ...
            },
            {
                ...
                'description': 'DotaDroid finds interesting Dota2 actions and upload them on YouTube.<br class="d-none d-lg-block"/>',
                'stack': [{'name': 'Python', 'link': 'https://www.python.org/'},
            ...
            },
            {
                ...
                'description': 'An alarm clock for android that talks and snoozes when flipped over.<br class="d-none d-lg-block"/>' +
